        ...
        <div id="about">
            ...
            <Container fluid className="about-section">
                ...
                <Iframe width="100%" height="400" src="https://www.youtube.com/embed/LO0BX94rx6k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></Iframe>
                    <p className="about-text"><span className="span">A</span>rial Beel is the third largest wetland in Bangladesh covering an area of 136 sq. km. It is situated in Sreenagar Upazila of Munshiganj District. The beel consists of many small ponds and canals. During the rainy season,
