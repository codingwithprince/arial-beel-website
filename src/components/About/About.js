    ...
    return (
        <div id="about">
            ...
            <Container fluid className="about-section">
                <Container>
                    <p className="about-text"><span>A</span>rial Beel is the third largest wetland in Bangladesh covering an area of 136 sq. km. It is situated in Sreenagar Upazila of Munshiganj District. The beel consists of many small ponds and canals. During the rainy season,
